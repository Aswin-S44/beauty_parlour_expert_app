        ...
        <ScrollView>
          ...
          <View>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.sectionText}>{offer?.category ?? '_'}</Text>
            </View>
            <View style={styles.section}>
              <Text style={styles.sectionTitle}>Service Price</Text>
              <Text style={styles.sectionText}>
                {offer?.regularPrice ?? '_'}
              </Text>
            </View>
            <View style={styles.section}>
              <Text style={styles.sectionTitle}>Offer Price</Text>
              <Text style={styles.sectionText}>{offer?.offerPrice ?? '_'}</Text>
            </View>
            <View style={styles.section}>
              <Text style={styles.sectionTitle}>Service Image</Text>
              <Image
                source={{ uri: offer?.service?.imageUrl ?? AVATAR_IMAGE }}
